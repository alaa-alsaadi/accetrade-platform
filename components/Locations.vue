...
const locations = [
  {
    city: 'بغداد',
    centers: ['العطيفية (شارع قاسم)', 'شارع الجهاد', 'الدورة (أبو دشير)']
  },
  {
    city: 'النجف',
    centers: ['المشخاب', 'المناذرة', 'منطقة مول النجف']
  },
  {
    city: 'البصرة',
    centers: ['شط العرب (الصالحية)']
  },
  {
    city: 'كربلاء',
    centers: ['قرب كليات التربية', 'حي الأمل']
  },
  {
    city: 'الموصل',
    centers: ['الزهور']
